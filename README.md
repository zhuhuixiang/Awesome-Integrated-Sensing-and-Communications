A curated list of Integrated Sensing &amp; Communications (**ISAC**), Integrated Sensing, Computation, and Communication (**ISCC**) publications in Top-tier Conferences and Journals, including IEEE Trans, ACM Journals, JSAC, IoTJ,  etc. 
...
| [Energy-Efficient Integrated Sensing and Communication: A Multi-Access Edge Computing Design](https://ieeexplore.ieee.org/abstract/document/10224278)  | Ning Huang | IEEE Commun. Lett.  2023 | Integrated sensing and communication, mobile edge computing, multi-access offloading  |   
